...
public:
	...
	static HomingBullet* Create(ID3D12Device* device, ID3D12GraphicsCommandList* arg_cmdList, Vector3 position = { 0.0f,0.0f,0.0f });
	...
	/// 更新処理
	/// </summary>
	void Update(const Vector3& incrementValue, const Vector3& arg_targetPosition);
