...
public:
	...
	static HomingBullet* Create(ID3D12Device* arg_device, ID3D12GraphicsCommandList* arg_cmdList,const Vector3& arg_position = { 0.0f,0.0f,0.0f });
	...
	void Update(const Vector3& arg_incrementValue, const Vector3& arg_targetPosition);
	...
	static void SetCamera(Camera* arg_camera) { HomingBullet::camera = arg_camera; }
...
public:
	...
	/// 移動処理
	/// </summary>
	/// <param name="arg_targetPosition">標的のポジション</param>
	void Move(const Vector3& arg_targetPosition);
};