...
//ボスクラス
class FinalBossEye :public GameObject
{
...
public:
	...
	static FinalBossEye* Create(ID3D12Device* arg_device, ID3D12GraphicsCommandList* arg_cmdList,const Vector3& position = { 0.0f,0.0f,0.0f });
	...
	static void SetCamera(Camera* arg_camera) { FinalBossEye::camera = arg_camera; }
...
public:
	...
	void SetParent(FinalBossEye* arg_parent) { parent = arg_parent; }
};
