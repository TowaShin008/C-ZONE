...
void BossScene1::LoadAllModel()
{
	...
	enemyPlaneModel.reset(ObjFileModel::CreateFromOBJ("Enemy_Plane"));
	...
	//モデルデータ1のロード(赤銃弾)
	redBulletModel.reset(ObjFileModel::CreateFromOBJ("fragment_bullet"));
...
void BossScene1::WarningProcessing()
{
	//WARNINGの点滅処理
	if (incrementFlag)
	{
